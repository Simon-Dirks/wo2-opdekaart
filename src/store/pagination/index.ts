...
export const paginationModule = {
    ...
    getters: {
        ...
        nextPageIsAvailable: (state: PaginationState, getters: any) => (maxElements: number): boolean => {
            return getters.getStartElemIdx + getters.getElemCount < maxElements;
        },
        getFinalPageNum: (state: PaginationState, getters: any) => (maxElements: number): number => {
